...
<block name="info">
    <form class="form-horizontal" action="{:U('Copyright/index')}" method="post" name="permission">
        <input type="hidden" name="id" value="{$copyRight.id}" />
        <div class="form-group">
            <label class="col-md-2 control-label">版權内容：</label>
            <div class="col-md-8">
                <textarea class="form-control" name="content" rows="10" placeholder="版權内容">{$copyRight.content}</textarea>
            </div>
        </div>
        <div class="form-group">
